...
const SignUp = () => {
    ...
    return (
        <div>
            <h2 className='text-5xl text-purple-600 my-6 font-bold text-center'>Sign Up</h2>
            <div className=" md:flex md:justify-between w-full">
           
           <div className='m-2 w-1/2 mx-auto'>

               <div className='flex flex-col justify-center'>
                   <form onSubmit={handleSignUp} className='max-w-[400px] w-full mx-auto rounded-lg shadow-2xl p-8 px-8'>
